...
export const owner: Keypair = Keypair.fromSecretKey(bs58.decode(process.env.ADMIN_PRIVATE_KEY || ''))
export const connection = new Connection(process.env.RPC_URL || '') //<YOUR_RPC_URL>
export const txVersion = TxVersion.V0 // or TxVersion.LEGACY
const cluster = process.env.CLUSTER as 'mainnet' | 'devnet' // 'mainnet' | 'devnet'
